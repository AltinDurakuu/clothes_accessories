...
<html lang="en">
  ...
  <body>
            ...
            <div class="navigation-right-side">
              <nav>
                <ul>
                  ...
                  <li><a href="clothes.php" class="active">Clothes</a></li>
    ...
    <section class="products-section products-accessories full-block" id="on-sale">
        <div class="container">
          <div class="grid-container a" id="clothes_grid">
          ...
          if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $queryForClothes .= " ORDER BY times_sold DESC";
              ...
              // Render the results
              renderResults3($result, "clothes_grid");
            ...
            require_once 'database.php';
                    ...
                    if ($result1) {
                      echo '<script>';
                      echo 'clothesGrid = document.getElementById("clothes_grid").innerHTML = "";';
                      echo '</script>';
                        renderResults($result1, "clothes_grid");
                    } else {
